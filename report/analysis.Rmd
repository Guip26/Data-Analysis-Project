...
admitted or with mentions.
In view of the results for 2020, which did not vary enormously, we will mainly
focus on the attribution of distinction in 2021.To do so, we create covid_vs_dnbmention.
```{r , echo=TRUE}
m<- dnb_results%>%
