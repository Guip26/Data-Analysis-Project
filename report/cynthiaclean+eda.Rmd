...
```{r , echo=TRUE}
covid_sp_dep_heb_cage_scol_2022_11_30_19h01 <- read_delim(here::here("data/covid_sp_dep_heb_cage_scol_2022_11_30_19h01.csv"), 
...
singpar_dnb <- left_join( x = single_parent, y = dnb_results, by =c("session","department_fr"))
singpar_dnb
```
...
barplot_pos <- ggplot(data = sp1_, aes(x=session, y= sing_par))+
