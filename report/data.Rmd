...
```
5.  We want some to know the attribution rate of each mention. It is needed in order to do some true comparisons between region without the same number of students.
```{r, echo = TRUE}
dnb_results <- dnb_results %>% 
